...
MAX_VALENCE = {'B': 3, 'Br':1, 'C':4, 'Cl':1, 'F':1, 'H':1, 'I':1, 'N':5, 'O':2, 'P':5, 'S':6, 'Se':4, 'Si':4}
...
def get_submol(mol, atom_indices, kekulize=False):
    if len(atom_indices) == 1:
        ...
        # Use proper SMILES format for single atoms
        if atom_symbol in ['Si', 'H', 'C', 'N', 'O', 'F', 'P', 'S', 'Cl', 'Br', 'I']:
